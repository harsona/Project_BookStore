...
<!-- 다국어 설정 및 로그인 링크 <fmt:message key="..."/>으로 변경 -->
		<div class="text-right">
			...
			<a href="logout.jsp" class="btn btn-warning pull-right text-light">logout</a>
		</div>
		...
		<form name="newBook" action="./processAddBook.jsp" class="form-horizontal" method="post" enctype="">
			...
			<div class="form-group row">
				...
				<div class="col-sm-5">
					<input type="text" id="bInStock" name="bInStock" class="form-control">
				</div>
			</div>
			<div class="form-group row">
			...
			<div class="form-group row">
				...
				<div class="col-sm-3">
					<!-- 유효성 검사 validation.js의 CheckAddBook() 메소드 삽입 -->
					<input type="button" class="btn btn-warning btn-block" value="<fmt:message key="button"/>" onclick="CheckAddBook()">
				</div>
			</div>
		</form>
	</div>
